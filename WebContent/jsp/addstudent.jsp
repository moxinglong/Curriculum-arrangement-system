    ...
    <script type="text/javascript">
    	...
    	layui.use(['form', 'layedit', 'laydate'], function(){
	    	 ...
	    	 form.on('select(province)', function(data){
	    		...
	    		$("#s_address").attr("value",p_val+$("#city").val());
	    	}); 
	    	 ...
	    	 form.on('select(city)', function(data){
	    		 ...
	    		 $("#s_address").attr("value",p_val+data.value);
	    	}); 
    	});
    </script>
</head>
...
<body>
   ...
   <form class="layui-form layui-form-pane" id="studentForm" action="${pageContext.request.contextPath}/StudentAction_save" method="post" style="margin:20px">

        <div class="layui-form-item">
            <div class="layui-inline">
			    <label class="layui-form-label">姓名</label>
			    <div class="layui-input-inline">
			      <input type="text" name="s_name" placeholder="请输入姓名" autocomplete="off" class="layui-input">
			    </div>
			</div>
           <div class="layui-inline">
		      <label class="layui-form-label">出生日期</label>
		      <div class="layui-input-inline">
		        <input type="text" name="s_birth" id="date" lay-verify="date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
		      </div>
		    </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="s_tel" placeholder="请输入联系电话" class="layui-input">
            </div>
        </div>
         <div class="layui-form-item">
         	<div class="layui-inline">
			...
			<input type="text" id="s_address" name="s_address" style="display: none;">
		</div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="s_major" placeholder="没有则不填" autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="s_school" placeholder="没有则不填" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                	<input type="hidden" id="c_id_true" name="cclass.c_id">
                    <input type="text" id="c_name_true" onfocus="window.open('${pageContext.request.contextPath}/ClassAction_list?select=true','','width=1300,height=500')" placeholder="没有则不填" autocomplete="off" class="layui-input" onclick="layui.laydate({elem: this})">                	
                </div>
            </div>
